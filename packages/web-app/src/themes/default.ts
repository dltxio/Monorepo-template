export const themes = {
  ...
  textarea: {
    base:
      "block border-gray-400 border p-2 w-full text-sm dark:text-gray-300 leading-5 rounded-md",
    active:
  ...
  input: {
    base:
      "block border-gray-400 bg-gray-50 border p-2 w-full text-sm dark:text-gray-300 leading-5 rounded-md",
    active:
  ...
  button: {
    ...
    dropdownItem: {
      base:
        "inline-flex items-center cursor-pointer w-full px-2 py-1 text-sm font-medium transition-colors duration-150 rounded-md hover:bg-gray-50 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
    }
  }
};
