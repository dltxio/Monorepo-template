...
const _default = {
  ...
  badge: {
    ...
    neutral: 'text-gray-700 bg-gray-50 dark:text-gray-100 dark:bg-gray-700',
  ...
  // Textarea
  textarea: {
    base: 'block border-gray-400 border p-2 w-full text-sm dark:text-gray-300 leading-5 rounded-md',
    active:
  ...
  // Input
  input: {
    base: 'block border-gray-400 bg-gray-100 border p-2 w-full text-sm dark:text-gray-300 leading-5 rounded-md',
    active:
      'focus:ring-2 focus:ring-blue-400 border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-300 dark:focus:border-gray-600 dark:focus:ring-gray-300 dark:bg-gray-700',
    disabled: 'cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800',
    valid:
      'border-green-600 dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:ring focus:ring-green-200 dark:focus:ring-green-200',
    invalid:
      'border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 focus:ring focus:ring-red-200 dark:focus:ring-red-200',
    radio:
      'text-blue-600 form-radio focus:border-blue-400 focus:ring-2 focus:ring-blue-300 focus:ring-offset-0 dark:focus:ring-gray-300',
    checkbox:
      'text-blue-600 form-checkbox focus:border-blue-400 focus:ring-2 focus:ring-blue-300 focus:ring-offset-0 rounded dark:focus:ring-gray-300',
  },
  // HelperText
  helperText: {
    base: 'text-xs',
  ...
  // Card
  card: {
    base: 'min-w-0 rounded-lg border  overflow-hidden',
  ...
  button: {
    ...
    primary: {
      ...
      active: 'active:bg-blue-600 hover:bg-blue-700',
      disabled: 'opacity-50 cursor-not-allowed',
    },
    outline: {
    ...
    link: {
      ...
      active:
        'active:bg-transparent hover:bg-gray-50 focus:ring focus:ring-gray-300 dark:hover:bg-gray-500 dark:hover:text-gray-300 dark:hover:bg-opacity-10',
      disabled: 'opacity-50 cursor-not-allowed',
    },
    // this is the button that lives inside the DropdownItem
    dropdownItem: {
      base: 'inline-flex items-center cursor-pointer w-full px-2 py-1 text-sm font-medium transition-colors duration-150 rounded-md hover:bg-gray-50 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200',
    },
  },
}
