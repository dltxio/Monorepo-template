...
export default {
  ...
  textarea: {
    base:
      "block border p-2 bg-gray-100 w-full text-sm dark:text-gray-300 rounded-md focus:outline-none",
    active:
  ...
  select: {
    base:
      "block border p-2 bg-gray-100 w-full text-sm  dark:text-gray-300 focus:outline-none rounded-md",
    active:
  ...
  input: {
    base:
      "block w-full p-2 text-sm border focus:outline-none dark:text-gray-300 leading-5 rounded-md",
    active:
    ...
    disabled: "cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800",
    valid:
      "dark:bg-gray-700 focus:border-green-400 dark:focus:border-green-400 focus:ring focus:ring-green-200 dark:focus:ring-green-200",
    invalid:
      "border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 focus:ring focus:ring-red-200 dark:focus:ring-red-200",
    radio:
