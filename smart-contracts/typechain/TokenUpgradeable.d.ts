...
interface TokenUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenUpgradeable extends BaseContract {
  ...
  interface: TokenUpgradeableInterface
